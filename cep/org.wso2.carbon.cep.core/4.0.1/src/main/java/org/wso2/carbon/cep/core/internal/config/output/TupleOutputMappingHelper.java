...
public class TupleOutputMappingHelper {
    ...
    public static OMElement tupleOutputMappingToOM(TupleOutputMapping outputMapping) {
        ...
        if (metaDataProperties != null) {
            AddProperties(factory, queryTupleOutputMappingElement, metaDataProperties);
        }
        ...
        List<TupleOutputProperty> correlationDataProperties = outputMapping.getMetaDataProperties();
        if (correlationDataProperties != null) {
            AddProperties(factory, queryTupleOutputMappingElement, correlationDataProperties);
        }
        ...
        List<TupleOutputProperty> payloadDataProperties = outputMapping.getMetaDataProperties();
        if (payloadDataProperties != null) {
            AddProperties(factory, queryTupleOutputMappingElement, payloadDataProperties);
        }
