...
public class CEPAdminService extends AbstractAdmin {
    ...
    private InputXMLMappingDTO adaptMapping(XMLInputMapping backEndXMLInputMapping) {
        ...
        inputXMLMappingDTO.setProperties(adaptXMLProperties(backEndXMLInputMapping.getProperties()));
    ...
    private InputTupleMappingDTO adaptMapping(TupleInputMapping backEndTupleInputMapping) {
        ...
        inputTupleMappingDTO.setProperties(adaptTupleProperties(backEndTupleInputMapping.getProperties()));
    ...
    private InputMapMappingDTO adaptMapping(MapInputMapping backEndMapInputMapping) {
        ...
        inputMapMappingDTO.setProperties(adaptMapProperties(backEndMapInputMapping.getProperties()));
     ...
     */
    private XMLPropertyDTO[] adaptXMLProperties(List<XMLProperty> backEndXMLPropertyList) {
     ...
     */
    private TuplePropertyDTO[] adaptTupleProperties(List<TupleProperty> backEndTuplePropertyList) {
     ...
     */
    private MapPropertyDTO[] adaptMapProperties(List<MapProperty> backEndMapPropertyList) {
