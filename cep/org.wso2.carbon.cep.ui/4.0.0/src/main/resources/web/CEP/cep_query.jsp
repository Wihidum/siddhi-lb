...
<tr inputName="outputElementMapping" style="display:<%=elementMapping!=null?"":"none" %>">
    <td colspan="2" class="middle-header">
...
<tr inputName="outputTupleMapping" style="display:<%=tupleMapping!=null?"":"none" %>">
    <td colspan="2" class="middle-header">
...
<tr inputName="outputMapMapping" style="display:<%=mapMapping!=null?"":"none" %>">
    <td colspan="2" class="middle-header">
