...
<div class="sectionSub">
    <table class="carbonFormTable">
        <tr>
            <td class="leftCol-med labelField"><fmt:message key="bucket.inputName"/></td>
        ...
        %>
        <tr inputName="providerConfig<%= "::"+engineProvider%>">
            ...
            <td>
                <input id="providerConfig<%="::"+engineProvider+"::"+engineProviderConfigProperties[k].getNames()%>"
                       ...
                       value="<%=engineProviderConfigProperties[k].getValues().startsWith("[")?engineProviderConfigProperties[k].getValues().substring(1,engineProviderConfigProperties[k].getValues().length()-1):engineProviderConfigProperties[k].getValues()%>"/>
            </td>
        </tr>
        <%
                }
            ...
            <td>
                ...
                <div class="sectionSub">
                    <table class="carbonFormTable">
                        ...
                        <tr>
                            <td class="leftCol-med labelField"><fmt:message key="broker.inputName"/></td>
                            ...
                            <td colspan="2">
                                <table class="styledLeft" style="width:100%">
                                    ...
                                    <th class="leftCol-med"><fmt:message
                                            key="inputProperty.inputName"/></th>
                                    <th class="leftCol-med"><fmt:message
                                            key="inputProperty.xpath"/></th>
                                    <th class="leftCol-med"><fmt:message
                                            key="inputProperty.type"/></th>
                                    </thead>
                                    <tbody>
                        ...
                        <tr>
                            <td colspan="2"><fmt:message key="inputProperty"/></td>
                        </tr>
                        <tr>
                            <td colspan="2">
                                <table class="styledLeft" style="width:100%">
                                    ...
                                    <th class="leftCol-med"><fmt:message
                                            key="inputProperty.inputName"/></th>
                                    <th class="leftCol-med"><fmt:message
                                            key="inputProperty.data.type"/></th>
                                    <th class="leftCol-med"><fmt:message
                                            key="inputProperty.type"/></th>
                                    </thead>
                                    <tbody>
...
<tr>
    ...
    <td class="leftCol-med labelField"><fmt:message key="query.inputName"/></td>
...
<tr>
    <td colspan="2">
        <table class="styledLeft" id="propertyTable" style="width:100%">
            ...
            <th class="leftCol-med"><fmt:message
                    key="inputProperty.xmlFName"/></th>
            <th class="leftCol-med"><fmt:message
                    key="inputProperty.xmlFType"/></th>
            </thead>
            <%
            ...
            <tbody>
            <%
                InputXMLPropertyDTO[] properties = elementMapping.getProperties();
...
<tr>
    <td colspan="2">
        <fmt:message key="inputProperty.data.type.meta"/>
    </td>
</tr>
<tr>
    <td colspan="2">
...
<tr>
    <td colspan="2">
        <fmt:message key="inputProperty.data.type.correlation"/>
    </td>
</tr>
<tr>
    <td colspan="2">
...
<tr>
    <td colspan="2">
        <fmt:message key="inputProperty.data.type.payload"/>
    </td>
</tr>
<tr>
    <td colspan="2">
