...
<%@ page import="org.wso2.carbon.cep.stub.admin.internal.xsd.MapInputPropertyDTO" %>
<%@ page import="org.wso2.carbon.cep.stub.admin.internal.xsd.TuplePropertyDTO" %>
<%@ page import="org.wso2.carbon.cep.stub.admin.internal.xsd.XMLInputPropertyDTO" %>
...
<tr inputName="inputXMLMapping" style="width:100%;<%=XMLMapping?"":"display:none;" %>">
    <td colspan="2" class="middle-header">
    ...
    <td colspan="2">
        ...
        <table id="addXMLInputPropertyTable" class="normal">
            ...
            <tr>
                ...
                <td><fmt:message key="inputProperty.xpath"/>: <input type="text" id="inputXMLPropValue"/>
                </td>
...
<tr inputName="inputTupleMapping" style="display:<%=(TupleMapping)?"":"none" %>;">
    <td colspan="2" class="middle-header">
        <fmt:message key="inputProperty"/>
    </td>
</tr>
<tr inputName="inputTupleMapping" style="display:<%=(TupleMapping)?"":"none" %>;">
    <td colspan="2">
        ...
        <table class="styledLeft" id="inputTuplePropertyTable"
            ...
            <%
                if (TupleMapping) {
                    if (tupleProperties != null) {
                        for (TuplePropertyDTO tupleInputPropertyDTO : tupleProperties) {
            %>
            <tr>
                <td><%=tupleInputPropertyDTO.getName()%>
                </td>
                <td><%=tupleInputPropertyDTO.getDataType()%>
                </td>
                <td><%=tupleInputPropertyDTO.getType()%>
                </td>
                <td><a class="icon-link"
                       style="background-image:url(../admin/images/delete.gif)"
            ...
            <script type="text/javascript">
                addInputPropertyToSession('<%=tupleInputPropertyDTO.getName()%>', '<%=tupleInputPropertyDTO.getDataType()%>', '<%=tupleInputPropertyDTO.getType()%>', 'tuple');
            </script>
            <%
                        }
                    }
...
<tr inputName="inputMapMapping" style="display:<%=(MapMapping)?"":"none" %>;">
    <td colspan="2" class="middle-header">
        <fmt:message key="inputProperty"/>
    </td>
</tr>
<tr inputName="inputMapMapping" style="display:<%=(MapMapping)?"":"none" %>;">
    <td colspan="2">
        ...
        <table class="styledLeft" id="inputMapPropertyTable"
            ...
            <%
                if (MapMapping) {
                    if (mapProperties != null) {
                        for (InputMapPropertyDTO mapInputPropertyDTO : mapProperties) {
            %>
            <tr>
                <td><%=mapInputPropertyDTO.getName()%>
                </td>
                <td><%=mapInputPropertyDTO.getType()%>
                </td>
                <td><a class="icon-link"
                       style="background-image:url(../admin/images/delete.gif)"
            ...
            <script type="text/javascript">
                addInputPropertyToSession('<%=mapInputPropertyDTO.getName()%>', '', '<%=mapInputPropertyDTO.getType()%>', 'map');
            </script>
            <%
                        }
                    }
