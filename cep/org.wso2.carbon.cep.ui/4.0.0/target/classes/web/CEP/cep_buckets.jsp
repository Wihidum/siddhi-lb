    ...
    <tr>
        <td class="formRaw">
            <table class="normal">
                ...
                %>
                <tr inputName="providerConfig<%= "::"+engineProviderInfo.getProviderName()%>">
...
<form name="inputsForm" action="cep_delete_inputs.jsp" method="post">
    ...
    <table class="styledLeft noBorders spacer-bot"
        ...
        <thead>
        <tr>
            <th><fmt:message key="topic.inputName"/></th>
            <th><fmt:message key="stream.inputName"/></th>
            <th><fmt:message key="broker.inputName"/></th>
        </tr>
        </thead>
...
<table id="addInputTable" class="styledLeft noBorders spacer-bot"
    ...
    <tr>
        <td class="leftCol-small"><fmt:message key="input.topic"/><font color="red"> *</font></td>
    ...
    <tr>
        <td class="leftCol-small"><fmt:message key="broker.inputName"/></td>
    ...
    <tr inputName="inputXMLMapping">
        <td colspan="2">
            ...
            <table class="styledLeft" id="inputXMLPropertyTable" style="width:100%;display:none">
                <thead>
                <th class="leftCol-med"><fmt:message key="inputProperty.inputName"/></th>
                <th class="leftCol-med"><fmt:message key="inputProperty.xpath"/></th>
                <th class="leftCol-med"><fmt:message key="inputProperty.type"/></th>
                <th><fmt:message key="actions"/></th>
                </thead>
            </table>
            ...
            <table id="addXMLInputPropertyTable" class="normal">
                <tbody>
                <tr>
                    <td class="leftCol-small"><fmt:message key="inputProperty.inputName"/>:</td>
                    <td><input type="text" id="inputXMLPropName"/></td>
                    <td><fmt:message key="inputProperty.xpath"/>: <input type="text"
                                                                    id="inputXMLPropValue"/></td>
                    <td><fmt:message key="inputProperty.type"/>:
    ...
    <tr inputName="inputTupleMapping" style="display: none">
        <td colspan="2" class="middle-header">
            <fmt:message key="inputProperty"/>
        </td>
    </tr>
    <tr inputName="inputTupleMapping" style="display: none">
        <td colspan="2">
            ...
            <table class="styledLeft" id="inputTuplePropertyTable" style="width:100%;display:none">
                <thead>
                <th class="leftCol-med"><fmt:message key="inputProperty.inputName"/></th>
                <th class="leftCol-med"><fmt:message key="inputProperty.data.type"/></th>
                <th class="leftCol-med"><fmt:message key="inputProperty.type"/></th>
                <th><fmt:message key="actions"/></th>
                </thead>
            </table>
            ...
            <table id="addTupleInputPropertyTable" class="normal">
                ...
                <tr>
                    ...
                    <td><fmt:message key="inputProperty.data.type"/>:
                        <select id="inputTuplePropertyDataTypes">
                            <option value="metaData"><fmt:message
                                    key="inputProperty.data.type.meta"/></option>
                            <option value="correlationData"><fmt:message
                                    key="inputProperty.data.type.correlation"/></option>
                            <option value="payloadData"><fmt:message
                                    key="inputProperty.data.type.payload"/></option>
                        </select>
                    </td>
                    <td><fmt:message key="inputProperty.type"/>:
    ...
    <tr inputName="inputMapMapping" style="display: none">
        <td colspan="2" class="middle-header">
            <fmt:message key="inputProperty"/>
        </td>
    </tr>
...
<form name="queriesForm" action="cep_delete_queries.jsp" method="post">
    ...
    { %>style="display:none"<% } %>
        ...
        <thead>
        <tr>
            <th><fmt:message key="query.inputName"/></th>
            <th><fmt:message key="topic.inputName"/></th>
            <th><fmt:message key="broker.inputName"/></th>
                <%--<th>Action</th>--%>
        </tr>
...
<tr>
    <td class="leftCol-small"><fmt:message key="query.inputName"/><span class="required">*</span></td>
...
<tr inputName="outputElementMapping" style="display: none">
    <td colspan="2" class="middle-header">
...
<tr inputName="outputElementMapping" style="display: none">
    <td colspan="2">
        ...
        <h4><fmt:message key="inputProperty"/></h4>
        <table class="styledLeft" id="outputElementPropertyTable" style="display:none">
            <thead>
            <th class="leftCol-med"><fmt:message key="inputProperty.inputName"/></th>
            <th class="leftCol-med"><fmt:message key="xml.field.inputName"/></th>
        ...
        <table id="addPropertyTable" class="normal">
            ...
            <tr>
                ...
                <td><fmt:message key="inputProperty.xmlFName"/> : <input type="text"
                                                                    id="xmlFieldName"/>
                </td>
                <td><fmt:message key="inputProperty.xmlFType"/> :
...
<tr inputName="outputTupleMapping" style="display: none">
    <td colspan="2" class="middle-header">
...
<tr inputName="outputTupleMapping" style="display: none">
    <td colspan="2">
        ...
        <h4><fmt:message key="inputProperty.data.type.meta"/></h4>
...
<tr inputName="outputTupleMapping" style="display: none">
    <td colspan="2">
        ...
        <h4><fmt:message key="inputProperty.data.type.correlation"/></h4>
...
<tr inputName="outputTupleMapping" style="display: none">
    <td colspan="2">
        ...
        <h4><fmt:message key="inputProperty.data.type.payload"/></h4>
...
<tr inputName="outputMapMapping" style="display: none">
    <td colspan="2" class="middle-header">
