...
public class QueueGrid<T> extends Queue<T> {
    static final Logger log = Logger.getLogger(QueueGrid.class);
    ...
    public QueueGrid(String elementId, SiddhiContext siddhiContext, boolean async) {
        this.async = async;
