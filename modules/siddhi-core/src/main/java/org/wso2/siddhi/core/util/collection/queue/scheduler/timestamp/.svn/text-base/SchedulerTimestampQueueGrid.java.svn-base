...
public class SchedulerTimestampQueueGrid<T extends StreamEvent> extends SchedulerQueueGrid<T> implements ISchedulerTimestampQueue<T> {
    static final Logger log = Logger.getLogger(SchedulerTimestampQueueGrid.class);
    private EntrySetComparator entrySetComparator = new EntrySetComparator();

    public SchedulerTimestampQueueGrid(String elementId, SchedulerElement schedulerElement,
