...
public class AndCondition extends Condition {
    ...
    protected void validate(List<QueryEventStream> queryEventStreamList, String streamReferenceId,
        ...
        leftCondition.validate(queryEventStreamList, streamReferenceId, processInStreamDefinition);
        rightCondition.validate(queryEventStreamList, streamReferenceId, processInStreamDefinition);
    }
}
