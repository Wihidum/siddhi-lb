...
public class SequenceStream implements Stream, SequenceElement {
    ...
    public List<QueryEventStream> constructEventStreamList(SequenceElement sequenceElement,
        ...
        if (sequenceElement instanceof BasicStream) {
            ...
            constructEventStreamList(((OrElement) sequenceElement).getTransformedStream1(), streamDefinitionMap, queryEventStreams);
            constructEventStreamList(((OrElement) sequenceElement).getTransformedStream2(), streamDefinitionMap, queryEventStreams);
        } else if (sequenceElement instanceof RegexElement) {
            constructEventStreamList(((RegexElement) sequenceElement).getTransformedStream(), streamDefinitionMap, queryEventStreams);
        } else if (sequenceElement instanceof NextElement) {
